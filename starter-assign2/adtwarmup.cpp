/* This file corresponds with ADT warmup
 * 1. View ADTs in debugger
 * 2. Test duplicateNegatives
 * 3. Debug duplicateNEgatives
 * 4. Diagnose a test that raises an error
 *
 * This file contains functions reverse, duplicateNegatives, and sumStack,
 * along with corresponding provided and student test cases.
*/
...
STUDENT_TEST("duplicateNegatives, input only has a single negative number") {
    Queue<int> q = {-1};
...
STUDENT_TEST("duplicateNegatives, input starts with a negative number") {
    Queue<int> q = {-1, 1};
...
STUDENT_TEST("duplicateNegatives, input ends with a negative number") {
    Queue<int> q = {1, -1};
    Queue<int> expected = {1, -1, -1};
...
STUDENT_TEST("duplicateNegatives, input starts and ends with negative numbers") {
    Queue<int> q = {-1, 1, -1};
...
STUDENT_TEST("duplicateNegatives, input contains only negative numbers") {
    Queue<int> q = {-1, -1};
