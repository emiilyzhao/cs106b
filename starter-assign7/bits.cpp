/**
 * This file contains the contents of the Bit type. The Bit represents a single value of 0 or 1,
 * and can be used interchangeably with the integers 0 and 1. If we try to assign a value that is
 * not 0 or 1 to Bit, an error is called.
 */
